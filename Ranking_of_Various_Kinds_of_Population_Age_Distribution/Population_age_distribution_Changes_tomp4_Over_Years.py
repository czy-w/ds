...
# 初始化线条
line_num_0_4, = ax.plot([], [], label='num 0-4', marker='s', color='blue', linewidth=2, alpha=0.6)
line_num_5_9, = ax.plot([], [], label='num 5-9', marker='^', color='red', linewidth=2, alpha=0.6)
line_num_10_14, = ax.plot([], [], label='num 10-14', marker='o', color='green', linewidth=2, alpha=0.6)
line_num_15_19, = ax.plot([], [], label='num 15-19', marker='^', color='purple', linewidth=2, alpha=0.6)
line_num_20_24, = ax.plot([], [], label='num 20-24', marker='o', color='orange', linewidth=2, alpha=0.6)
line_num_25_29, = ax.plot([], [], label='num 25-29', marker='^', color='pink', linewidth=2, alpha=0.6)
line_num_30_34, = ax.plot([], [], label='num 30-34', marker='s', color='brown', linewidth=2, alpha=0.6)
line_num_35_39, = ax.plot([], [], label='num 35-39', marker='^', color='gray', linewidth=2, alpha=0.6)
line_num_40_44, = ax.plot([], [], label='num 40-44', marker='s', color='cyan', linewidth=2, alpha=0.6)
line_num_45_49, = ax.plot([], [], label='num 45-49', marker='^', color='magenta', linewidth=2, alpha=0.6)
line_num_50_54, = ax.plot([], [], label='num 50-54', marker='s', color='lime', linewidth=2, alpha=0.6)
line_num_55_59, = ax.plot([], [], label='num 55-59', marker='^', color='navy', linewidth=2, alpha=0.6)
line_num_60_64, = ax.plot([], [], label='num 60-64', marker='s', color='gold', linewidth=2, alpha=0.6)
line_num_65_69, = ax.plot([], [], label='num 65-69', marker='^', color='teal', linewidth=2, alpha=0.6)
line_num_70_74, = ax.plot([], [], label='num 70-74', marker='s', color='maroon', linewidth=2, alpha=0.6)
line_num_75_79, = ax.plot([], [], label='num 75-79', marker='^', color='silver', linewidth=2, alpha=0.6)
line_num_80_84, = ax.plot([], [], label='num 80-84', marker='s', color='olive', linewidth=2, alpha=0.6)
line_num_85_89, = ax.plot([], [], label='num 85-89', marker='^', color='indigo', linewidth=2, alpha=0.6)
line_num_90_94, = ax.plot([], [], label='num 90-94', marker='s', color='violet', linewidth=2, alpha=0.6)
line_num_95_, = ax.plot([], [], label='num 95-', marker='^', color='red', linewidth=2, alpha=0.6)
# line_num_all, = ax.plot([], [], label='num all', marker='^', color='black', linewidth=2, alpha=0.6)
...
def update(frame):
    ...
    highlight_num_5_9 = ax.scatter(years[current_year_index], num_5_9[current_year_index], color='red', s=100, zorder=5)
    highlight_num_10_14 = ax.scatter(years[current_year_index], num_10_14[current_year_index], color='green', s=100, zorder=5)
    highlight_num_15_19 = ax.scatter(years[current_year_index], num_15_19[current_year_index], color='purple', s=100, zorder=5)
    highlight_num_20_24 = ax.scatter(years[current_year_index], num_20_24[current_year_index], color='orange', s=100, zorder=5)
    highlight_num_25_29 = ax.scatter(years[current_year_index], num_25_29[current_year_index], color='pink', s=100, zorder=5)
    highlight_num_30_34 = ax.scatter(years[current_year_index], num_30_34[current_year_index], color='brown', s=100, zorder=5)
    highlight_num_35_39 = ax.scatter(years[current_year_index], num_35_39[current_year_index], color='gray', s=100, zorder=5)
    highlight_num_40_44 = ax.scatter(years[current_year_index], num_40_44[current_year_index], color='cyan', s=100, zorder=5)
    highlight_num_45_49 = ax.scatter(years[current_year_index], num_45_49[current_year_index], color='magenta', s=100, zorder=5)
    highlight_num_50_54 = ax.scatter(years[current_year_index], num_50_54[current_year_index], color='lime', s=100, zorder=5)
    highlight_num_55_59 = ax.scatter(years[current_year_index], num_55_59[current_year_index], color='navy', s=100, zorder=5)
    highlight_num_60_64 = ax.scatter(years[current_year_index], num_60_64[current_year_index], color='gold', s=100, zorder=5)
    highlight_num_65_69 = ax.scatter(years[current_year_index], num_65_69[current_year_index], color='teal', s=100, zorder=5)
    highlight_num_70_74 = ax.scatter(years[current_year_index], num_70_74[current_year_index], color='maroon', s=100, zorder=5)
    highlight_num_75_79 = ax.scatter(years[current_year_index], num_75_79[current_year_index], color='silver', s=100, zorder=5)
    highlight_num_80_84 = ax.scatter(years[current_year_index], num_80_84[current_year_index], color='olive', s=100, zorder=5)
    highlight_num_85_89 = ax.scatter(years[current_year_index], num_85_89[current_year_index], color='indigo', s=100, zorder=5)
    highlight_num_90_94 = ax.scatter(years[current_year_index], num_90_94[current_year_index], color='violet', s=100, zorder=5)
    highlight_num_95_ = ax.scatter(years[current_year_index], num_95_[current_year_index], color='red', s=100, zorder=5)                          
    # highlight_num_all = ax.scatter(years[current_year_index], num_all[current_year_index], color='black', s=100, zorder=5)                          
    ...
    for i in range(current_year_index + 1):
        ...
        # text_num_all = ax.text(years[i], num_all[i] - 0.5, str(years[i]), fontsize=8, ha='center', va='top', color='black')
        ...
        text_labels.extend([text_num_0_4, text_num_5_9, text_num_10_14, text_num_15_19, text_num_20_24, 
                            ...
                            text_num_75_79, text_num_80_84, text_num_85_89, text_num_90_94, text_num_95_])
    ...
    ne =  [line_num_0_4, line_num_5_9, line_num_10_14, line_num_15_19, line_num_20_24, line_num_25_29, line_num_30_34, line_num_35_39,
            line_num_40_44, line_num_45_49, line_num_50_54, line_num_55_59, line_num_60_64, line_num_65_69, line_num_70_74, line_num_75_79,
              line_num_80_84, line_num_85_89, line_num_90_94, line_num_95_]
    return [highlighted_points, text_labels, ne]


def extended_frames():
    for frame in range(len(years)):
        for _ in range(5):  # 每个原始帧重复3次
            yield frame
...
# # 保存为MP4视频
# ani.save('Population_age_distribution_Changes_Over_Years.mp4', writer='ffmpeg', fps=1)
# logging.debug("保存动画")
...
ani = animation.FuncAnimation(fig, update, frames=extended_frames, repeat=False)

# 设置FFmpeg writer并保存动画为MP4文件
Writer = animation.writers['ffmpeg']
writer = Writer(fps=1, metadata=dict(artist='Me'), bitrate=1800)
ani.save('population_age_distribution_changes.mp4', writer=writer)
