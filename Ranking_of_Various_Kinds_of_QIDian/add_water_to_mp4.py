...
def create_floating_watermarks(video_clip, num_watermarks=10):
    ...
    for _ in range(num_watermarks):
        ...
        watermark = animated_watermark.with_position(make_frame)
...
if __name__ == "__main__":
    input_file = "Ranking_of_Various_Kinds_of_QiDian.mp4"
    output_file = "Water_Ranking_of_Various_Kinds_of_QiDian.mp4"
